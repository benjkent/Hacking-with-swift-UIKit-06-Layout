//
//  LeadTrailAnchorViewController.swift
//  Layouts
//
...
class LeadTrailAnchorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "Leading & Trailing Anchor Constraints"
        let label1 = UILabel()
        ...
        label4.text = "Leading and trailing anchor"
        label4.sizeToFit()
